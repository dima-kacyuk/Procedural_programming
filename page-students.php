...
<main>
  ...
  <div class="extra_menu">
    ...
    <div class="container">
      ...
      <ul class="extra_menu_ul">
        ...
        <!-- <li><a href="http://ics.odessa.ua/page-">Личный кабинет</a></li> -->
  ...
  <div class="container">
    ...
    <div class="graduates_login">

      <?php

      echo "<a href='http://ics.odessa.ua/page-";
      ...
      echo "<div class='private_office'>Личный кабинет</div></a>"; 
