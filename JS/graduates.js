$(function() {
    ...
    function viewNewsForGraduates() {
      ...
      $.ajax({
        ...
        url: 'http://ics.odessa.ua/view-news-for-graduates.php',
        ...
        success: function(response) {
          ...
          $('#news-for-graduates-container').append(response);
  
        },
  
        error: function() {
  
          alert('News For Graduates View Error');
    ...
    $(document).on('click', '.news_read', function() {
       ...
       $.ajax({
         ...
         url: 'http://ics.odessa.ua/read_news.php',
  ...
  jQuery(window).load(function() {
    ...
    $('#news-for-graduates-container').MyPagination({height: 400, fadeSpeed: 0});
