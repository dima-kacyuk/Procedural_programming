...
<?php include 'http://ics.odessa.ua/qa/qa-header.php'; ?>
...
objRef.style.cssText = "overflow:hidden; position:relative;";
      ...
      overflow.onclick = function () {
        modal.style.top = "-100%";
objRef.style.cssText = "width:100%; height:100%; overflow: visible; position:relative;";
        overflow.remove();
      }
